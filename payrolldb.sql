...
--
-- Host: localhost
-- Generation Time: Apr 20, 2022 at 04:59 PM
...
('ada01', 'ada', 'abuede', 'pearl', 'pipeline', 123456, 'Single', '2021-06-14', 'warri', 'Female', 12, 123456),
...
(24, 'ada01', 500, 'Monthly', 'regular', 'Active', '2022-04-04');
...
CREATE TABLE IF NOT EXISTS `other_deduction` (
...
(12, 'admin', 'admin', 'admin1234', 'Administrator'),
(14, 'bebe', 'bebe', 'bebe', 'Staff');
